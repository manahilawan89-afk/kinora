...
function getErrorMessage(err) {
  ...
  return err.message || err.error || "Registration failed";
}
  ...
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-md items-center px-1 sm:min-h-[70vh]">
      ...
      >
        ...
        <input
          className="w-full rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-2.5 text-zinc-900 outline-none focus:border-teal-600 dark:border-white/10 dark:bg-black/30 dark:text-zinc-100"
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-2.5 pr-12 text-zinc-900 outline-none focus:border-teal-600 dark:border-white/10 dark:bg-black/30 dark:text-zinc-100"
        ...
        <p className="text-center text-sm text-zinc-500 dark:text-zinc-400">
          ...
          <Link to="/login" className="text-teal-700 hover:underline dark:text-kinora-glow">
            Sign in
          </Link>
        </p>
      </motion.form>
